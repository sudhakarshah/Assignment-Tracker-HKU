  ...
  chrome.storage.sync.get(null,function(assignments){
      ...
      for (key in assignments)
      {
        ...
        else
        {
          ...
          var id = guidGenerator();
          var html = '<li class="card coursecard"' + 'id="'+ id + '"><span class="cardtext"><span class="cardtitle">' + coursecode + ' (' + as.assignmentName + ')' + '</span><br><span class="cardBody">' + coursestring + '</span><br><br><span class="cardBody">' + 'Completed on:  ' + submittedOnDateNum.toString() + '-' +  submittedOnMonth.toString() + '-' + submittedOnYear.toString() + ',' + ' ' + submittedOnTime  + '</span></span><br><br><div><input type = "checkbox" class="deletebutton" id="'+buttonid+'"> <label class="cardStatus" for="'+ buttonid+ '"><span class="cardtext"></span>Delete</label>' + '</div><div><input type = "checkbox" class="incompletebutton" id="' +buttonid+'"> <label class="cardStatus" for="'+ buttonid+ '"><span class="cardtext"></span>Mark as Incomplete</label></div></li>';
